 ...
 * @author PC
 */
public class InterfazMostrarProducto extends javax.swing.JFrame {
     ...
     */
    public InterfazMostrarProducto() {
        ...
        try {
                ...
                if(rs.next()){
                    ...
                    try {
                        ...
                        Logger.getLogger(InterfazMostrarProducto.class.getName()).log(Level.SEVERE, null, e);
                    }                    
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButtonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 480, 140, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazMostrarProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazMostrarProducto().setVisible(true);
            }
        });
    }
